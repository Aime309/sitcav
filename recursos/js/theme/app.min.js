...
settings.Direction = document.documentElement.dir;
settings.ColorTheme = document.documentElement.dataset.colorTheme;
settings.Layout = document.documentElement.dataset.layout;
settings.BoxedLayout = document.documentElement.dataset.boxedLayout === 'boxed';
settings.SidebarType = document.body.dataset.sidebartype;
settings.cardBorder = document.documentElement.dataset.card === 'border';
