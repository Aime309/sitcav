<script>
  import MenuPrivado from "../componentes/MenuPrivado.svelte";
  import PieDePagina from "../componentes/PieDePagina.svelte";
  import Contadores from "../componentes/Contadores.svelte";
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-8 col-sm-8 col-xs-12">
      <div
        id="carousel-example"
        class="carousel slide slide-bdr"
        data-ride="carousel"
      >
                  ...
                  <div class="media-body">
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        ...
                        Donec sit amet ligula enim. Duis vel condimentum massa. Maecenas
                        eget congue dui. Vestibulum et eros consectetur, interdum
                        nibh et, volutpat dolor.
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="col-md-4 col-sm-4 col-xs-12">
      <div class="alert alert-info text-center">
        ...
        <p>
          ...
          dolor sit amet, consectetur adipiscing elit gthn. Lorem ipsum dolor
          sit amet.
        </p>
        <hr />
