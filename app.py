...
def create_cliente():
    ...
    if not data.get('nombre') or not data.get('cedula'):
        return jsonify({"message": "Nombre y cédula son requeridos", "success": False}), 400
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({"message": f"Error al crear cliente: {str(e)}", "success": False}), 400
...
def update_cliente(id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({"message": f"Error al actualizar cliente: {str(e)}", "success": False}), 400
...
def delete_cliente(id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({"message": f"Error al eliminar cliente: {str(e)}", "success": False}), 500
...
def create_categoria():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({"message": f"Error al crear categoría: {str(e)}", "success": False}), 400
...
def delete_categoria(id):
    ...
    try:
        ...
        db.session.commit()
        return jsonify({"message": "Categoría eliminada correctamente", "success": True})
    except Exception as e:
        db.session.rollback()
        return jsonify({"message": f"Error al eliminar categoría: {str(e)}", "success": False}), 400
...
def list_productos():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({"message": f"Error al crear producto: {str(e)}", "success": False}), 400
...
def update_producto(id):
    ...
    try:
        ...
        producto.precio_unitario_actual_dolares = Decimal(str(data.get('precio_unitario_actual_dolares', producto.precio_unitario_actual_dolares)))
        ...
        db.session.rollback()
        return jsonify({"message": f"Error al actualizar producto: {str(e)}", "success": False}), 400
...
def delete_producto(id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({"message": f"Error al eliminar producto: {str(e)}", "success": False}), 500
