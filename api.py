...
@api_bp.get("/productos/stock-bajo")
...
@api_bp.get("/reportes/estadisticas")
...
@api_bp.get("/reportes/ventas/pdf")
...
@api_bp.get("/inventario/movimientos")
...
@api_bp.get("/consultas/ventas/pdf")
...
@api_bp.get("/estadisticas/resumen")
...
@api_bp.get("/estadisticas/historico")
