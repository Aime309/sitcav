...
4. Espera 1-2 minutos. Tu web queda en: `https://Laikimist.github.io/sitcav/`
...
4. Sube DENTRO de `htdocs/sitcav/` estos 4 archivos (tal cual, sin subcarpetas):
   ...
   - `tienda.html`
   - `tienda.js`
5. Tu web queda en: `https://aimee.42web.io/sitcav/`

## PASO 2 — Probar

- Abre tu web (`https://Laikimist.github.io/sitcav/` o
  `https://aimee.42web.io/sitcav/`) → se carga la TIENDA (landing).
- Registra un cliente (con captcha), inicia sesión, aparta un producto.
- Para el panel: entra por el link de abajo de la tienda o navega a
  `index.html` (sección de login). Usa tus credenciales exportadas.
...
- No subas `app.js?v=19` — sube `app.js` (el `?v=` es solo cache-buster).
