      ...
      <table class="table text-nowrap mb-0 align-middle table-hover">
        ...
        <tbody>
          <tr>
            <td>
              <div class="d-flex align-items-center product">
                <img src="./recursos/imagenes/products/s1.jpg" class="img-fluid flex-shrink-0 rounded"
                  width="60" height="60" />
          ...
          <tr>
            <td>
              <div class="d-flex align-items-center product">
                <img src="./recursos/imagenes/products/s2.jpg" class="img-fluid flex-shrink-0 rounded"
                  width="60" height="60" />
                <div class="ms-3 product-title">
                  <h6 class="fs-3 mb-0 text-truncate-2">
          ...
          <tr>
            <td>
              <div class="d-flex align-items-center product">
                <img src="./recursos/imagenes/products/s3.jpg" class="img-fluid flex-shrink-0 rounded"
                  width="60" height="60" />
                <div class="ms-3 product-title">
                  <h6 class="fs-3 mb-0 text-truncate-2">
          ...
          <tr>
            <td>
              <div class="d-flex align-items-center product">
                <img src="./recursos/imagenes/products/s5.jpg" class="img-fluid flex-shrink-0 rounded"
                  width="60" height="60" />
                <div class="ms-3 product-title">
                  <h6 class="fs-3 mb-0 text-truncate-2">
