...
<body>
            ...
            <div class="mini-nav">
              <div class="brand-logo d-flex align-items-center justify-content-between justify-content-lg-center">
                <a href="./" class="text-nowrap logo-img">
                  <img src="./recursos/imagenes/favicon.png" alt="Logo" width="40" />
                </a>
          ...
          <div class="row">
              ...
              <div class="card w-100 bg-primary">
                <div class="card-body position-relative">
                  ...
                  <div class="make-social-media d-none d-sm-block">
                    <img src="../assets/images/backgrounds/make-social-media.png" class="img-fluid" alt="MaterialM-img" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-8 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  <div class="d-md-flex mb-2 justify-content-between align-items-center">
                    <h4 class="mb-4 mb-md-0 card-title">Sales Profit</h4>
                    <ul class="nav nav-tabs nav-justified theme-tab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active w-100" data-bs-toggle="tab" href="#one" role="tab">
                          <span>Profit</span>
                        </a>
                      </li>
                      <li class="nav-item">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="one" role="tabpanel">
                      <div class="d-flex flex-column me-n2 mb-7">
                        <div id="sales-profit"></div>
                      </div>
                      <div class="d-md-flex align-items-center justify-content-between">
                        <div class="d-md-flex align-items-center gap-7">
                          <div class="hstack gap-6 mb-3 mb-md-0">
                            <div class="rounded-circle-shape bg-primary-subtle rounded-5 d-flex align-items-center justify-content-center">
                              <iconify-icon icon="solar:checklist-minimalistic-line-duotone" class="fs-7 text-primary"></iconify-icon>
                            </div>
                            <div>
                              <h6 class="mb-0 fs-4">
                                $63,489.50<span class="badge rounded-pill bg-success-subtle text-success fs-2 fw-medium ms-1">+8%</span>
                              </h6>
                          ...
                          <!-- 2 -->
                          <div class="hstack gap-6 mb-3 mb-md-0">
                            <div class="rounded-circle-shape bg-light rounded-5 d-flex align-items-center justify-content-center">
                              <iconify-icon icon="solar:dollar-minimalistic-line-duotone" class="fs-7 text-muted"></iconify-icon>
                            </div>
                            <div>
                              <h6 class="mb-0 fs-4">$38,496.00</h6>
                              <span>Profit last year</span>
                            </div>
                          </div>
                        </div>
                        <a href="javascript:void(0)" class="btn btn-primary px-5">View Details</a>
                      </div>
                    </div>
                    <div class="tab-pane" id="two" role="tabpanel">
                      <div class="rounded-bars me-n4">
                        <div id="sales-profit2"></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-4 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  <div class="d-flex mb-7 justify-content-between align-items-center">
                  ...
                  <div class="text-center mb-4 mt-n3">
                    <span class="badge rounded-pill bg-success-subtle text-success py-2 p-6 fs-2 fw-medium">
                      <img src="../assets/images/svgs/icon-bolt.svg" alt="best-seller" class="img-fluid" />
                      Best Seller
                    </span>
                  </div>

                  <div class="hstack justify-content-center gap-6 pb-4 border-muted border-bottom mt-4">
                    <div class="row gx-0">
                      <div class="col-6">
                        <div class="hstack gap-2 mb-6">
                          <span class="circle-shape bg-primary rounded-pill"></span>
                          <h6 class="mb-0 fw-normal">36% Modernize</h6>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="hstack gap-2 mb-6">
                          <span class="circle-shape bg-success rounded-pill"></span>
                          <h6 class="mb-0 fw-normal">17% Spike</h6>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="hstack gap-2 mb-6">
                          <span class="circle-shape bg-secondary rounded-pill"></span>
                          <h6 class="mb-0 fw-normal">22% Ample</h6>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="hstack gap-2 mb-6">
                          <span class="circle-shape bg-danger rounded-pill"></span>
                          <h6 class="mb-0 fw-normal">31% MaterialM</h6>
                        </div>
                      </div>
                    </div>
                  </div>
                  <p class="mb-0 text-center pt-7 fs-2 px-4 fw-medium">
                    This is overview of the sales happened this month for the
                    material website
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-5">
              <div class="card w-100">
                <div class="card-body">
                  <div class="d-flex mb-3 justify-content-between align-items-center pb-1">
                    <h4 class="mb-0 card-title">Marketing Report</h4>
                    <div class="dropdown">
                      <button id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" class="rounded-circle btn-transparent rounded-circle btn-sm px-1 btn shadow-none">
                        <i class="material-symbols-outlined fs-7 d-block">more_vert</i>
                      </button>
                  ...
                  <div class="row align-items-center mb-4 pb-6">
                    <div class="col-lg-6">
                      <ul class="list-unstyled mb-0">
                        <li class="d-flex align-items-center mb-4">
                          <div class="rounded-circle-shape bg-danger-subtle text-danger px-3 py-2 me-3 rounded-5 d-flex align-items-center justify-content-center">
                            <iconify-icon icon="solar:course-up-line-duotone" class="fs-7"></iconify-icon>
                          </div>
                          <div>
                            <p class="mb-0 fs-3 text-nowrap">Google Ads</p>
                            <h6 class="mb-0 fs-6">+2.9k</h6>
                          </div>
                        </li>
                        <li class="d-flex align-items-center mb-4">
                          <div class="rounded-circle-shape bg-success-subtle text-success px-3 py-2 me-3 rounded-5 d-flex align-items-center justify-content-center">
                            <iconify-icon icon="solar:cursor-line-duotone" class="fs-7"></iconify-icon>
                          </div>
                          <div>
                            <p class="mb-0 fs-3 text-nowrap">Referral</p>
                            <h6 class="mb-0 fs-6">1.22</h6>
                          </div>
                        </li>
                        <li class="d-flex align-items-center">
                          <div class="rounded-circle-shape bg-primary-subtle text-primary px-3 py-2 me-3 rounded-5 d-flex align-items-center justify-content-center">
                            <iconify-icon icon="solar:pie-chart-3-line-duotone" class="fs-7"></iconify-icon>
                          </div>
                          <div>
                            <p class="mb-0 fs-3 text-nowrap">Oraganic</p>
                            <h6 class="mb-0 fs-6">24.3K</h6>
                          </div>
                        </li>
                      </ul>
                    </div>
                    <div class="col-lg-6">
                      <div class="text-center">
                        <div id="marketing-report"></div>
                      </div>
                    </div>
                  </div>
                  <div class="bg-light rounded-4 px-10 py-6">
                    <div class="d-flex align-items-center justify-content-between">
                      ...
                      <a href="javascript:void()" class="btn round-40 flex-shrink-0 d-flex align-items-center justify-content-center bg-primary rounded-circle">
                        <iconify-icon icon="solar:play-line-duotone" class="fs-5 text-white">
                        </iconify-icon>
                      </a>
                    </div>
                  </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0 card-title">Payments</h4>
                    <div class="dropdown">
                      <button id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" class="rounded-circle btn-transparent rounded-circle btn-sm px-1 btn shadow-none">
                        <i class="material-symbols-outlined fs-7 d-block">more_vert</i>
                      </button>
                  ...
                  <div>
                    <h6 class="mb-0 fs-6 hstack gap-1">
                      12,389<span class="badge rounded-pill bg-danger-subtle text-danger fs-2 fw-medium ms-1">-3.8%</span>
                    </h6>
                    <span>Last 7 days</span>
                  </div>
                  <div class="me-n4 mb-9">
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0 card-title">Annual Profit</h4>
                    <div class="dropdown">
                      <button id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" class="rounded-circle btn-transparent rounded-circle btn-sm px-1 btn shadow-none">
                        <i class="material-symbols-outlined fs-7 d-block">more_vert</i>
                      </button>
                  ...
                  <div class="bg-primary-subtle rounded overflow-hidden mb-3">
                    <div class="p-4">
                      <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="card w-100">
                <div class="card-body pb-6">
                  <div class="d-flex mb-3 justify-content-between align-items-center">
                    <h4 class="mb-0 card-title">Top Performing Products</h4>
                    <div class="dropdown">
                      <button id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" class="rounded-circle btn-transparent rounded-circle btn-sm px-1 btn shadow-none">
                        <i class="material-symbols-outlined fs-7 d-block">more_vert</i>
                      </button>
                  ...
                  <div class="table-responsive" data-simplebar>
                    <table class="table top-performing-products-table table-borderless align-middle text-nowrap mb-0">
                      <thead class="border-bottom border-light-primary">
                        <tr>
                          <th scope="col" class="ps-0 p-3">Product Name</th>
                          <th scope="col" class="p-3">Category</th>
                          <th scope="col" class="p-3">Sales</th>
                          <th scope="col" class="p-3">Earnings</th>
                          <th scope="col" class="p-3 text-end pe-0">Technology</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td class="ps-0">
                            <div class="hstack gap-6">
                              <span class="round-56 hstack justify-content-center bg-primary-subtle rounded">
                                <img src="../assets/images/svgs/icon-materialM.svg" class="img-fluid" alt="" />
                              </span>
                              <div>
                                <h6 class="mb-0 fs-12 fw-normal">MaterialM - Admin</h6>
                                <h6 class="mb-0 fs-12 fw-normal">Dashboard Template</h6>
                              </div>
                            </div>
                          </td>
                          <td>
                            <span class="badge bg-primary-subtle rounded-pill text-primary fs-2 fw-medium">Mobile</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">2,350</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">$24,235</span>
                          </td>
                          <td class="text-end pe-0">
                            <img src="../assets/images/svgs/icon-photoshop.svg" class="img-fluid" alt="" />
                          </td>
                        </tr>
                        <tr>
                          <td class="ps-0">
                            <div class="hstack gap-6">
                              <span class="round-56 hstack justify-content-center bg-secondary-subtle rounded">
                                <img src="../assets/images/svgs/icon-matdash.svg" class="img-fluid" alt="" />
                              </span>
                              <div>
                                <h6 class="mb-0 fs-12 fw-normal">MatDash - Admin</h6>
                                <h6 class="mb-0 fs-12 fw-normal">Dashboard Template</h6>
                              </div>
                            </div>
                          </td>
                          <td>
                            <span class="badge bg-success-subtle rounded-pill text-success fs-2 fw-medium">Web App</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">1,630</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">$13,699</span>
                          </td>
                          <td class="text-end pe-0">
                            <div class="hstack justify-content-end gap-2">
                              <img src="../assets/images/svgs/icon-figma.svg" class="img-fluid" alt="" />
                              <img src="../assets/images/svgs/icon-veu.svg" class="img-fluid" alt="" />
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td class="ps-0">
                            <div class="hstack gap-6">
                              <span class="round-56 hstack justify-content-center bg-success-subtle rounded">
                                <img src="../assets/images/svgs/icon-spike.svg" class="img-fluid" alt="" />
                              </span>
                              <div>
                                <h6 class="mb-0 fs-12 fw-normal">Spike - Admin</h6>
                                <h6 class="mb-0 fs-12 fw-normal">Dashboard Template</h6>
                              </div>
                            </div>
                          </td>
                          <td>
                            <span class="badge bg-danges-subtle rounded-pill text-danges fs-2 fw-medium">Website</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">480</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">$9,640</span>
                          </td>
                          <td class="text-end pe-0">
                            <div class="hstack justify-content-end gap-2">
                              <img src="../assets/images/svgs/icon-xd.svg" class="img-fluid" alt="" />
                              <img src="../assets/images/svgs/icon-bootstrap.svg" class="img-fluid" alt="" />
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td class="ps-0">
                            <div class="hstack gap-6">
                              <span class="round-56 hstack justify-content-center bg-warning-subtle rounded">
                                <img src="../assets/images/svgs/icon-modernize.svg" class="img-fluid" alt="" />
                              </span>
                              <div>
                                <h6 class="mb-0 fs-12 fw-normal">Modernize - Admin</h6>
                                <h6 class="mb-0 fs-12 fw-normal">Dashboard Template</h6>
                              </div>
                            </div>
                          </td>
                          <td>
                            <span class="badge bg-success-subtle rounded-pill text-success fs-2 fw-medium">Marketing</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">874</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">$10,250</span>
                          </td>
                          <td class="text-end pe-0">
                            <img src="../assets/images/svgs/icon-angular.svg" class="img-fluid" alt="" />
                          </td>
                        </tr>
                        <tr>
                          <td class="ps-0">
                            <div class="hstack gap-6">
                              <span class="round-56 hstack justify-content-center bg-danger-subtle rounded">
                                <img src="../assets/images/svgs/icon-materialpro.svg" class="img-fluid" alt="" />
                              </span>
                              <div>
                                <h6 class="mb-0 fs-12 fw-normal">MaterialPro - Admin</h6>
                                <h6 class="mb-0 fs-12 fw-normal">Dashboard Template</h6>
                              </div>
                            </div>
                          </td>
                          <td>
                            <span class="badge bg-warning-subtle rounded-pill text-warning fs-2 fw-medium">SSM</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">3715</span>
                          </td>
                          <td>
                            <span class="fs-3 fw-normal">$36,400</span>
                          </td>
                          <td class="text-end pe-0">
                            <div class="hstack justify-content-end gap-2">
                              <img src="../assets/images/svgs/icon-nextjs.svg" class="img-fluid" alt="" />
                              <img src="../assets/images/svgs/icon-javascript.svg" class="img-fluid" alt="" />
                            </div>
                          </td>
                        </tr>
                      </tbody>
                ...
                <div class="card-body">
                  ...
                  <div class="position-relative">
                    <div class="d-flex align-items-center justify-content-between mb-7">
                      <div class="d-flex">
                        <div class="round-40 bg-secondary-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-paypal.svg" alt="modernize-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                          <h6 class="mb-0 fs-4">PayPal Transfer</h6>
                          <p class="fs-3 mb-0">Money added</p>
                        </div>
                      </div>
                      <h6 class="mb-0 fs-4 fw-normal">+$6,235</h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-7">
                      <div class="d-flex">
                        <div class="round-40 bg-success-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-office-bag.svg" alt="modernize-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                          <h6 class="mb-0 fs-4">Wallet</h6>
                          <p class="fs-3 mb-0">Bill payment</p>
                        </div>
                      </div>
                      <h6 class="mb-0 text-muted fw-normal">+$345</h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-7">
                      <div class="d-flex">
                        <div class="round-40 bg-warning-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-master-card.svg" alt="modernize-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                          <h6 class="mb-0 fs-4">Credit card</h6>
                          <p class="fs-3 mb-0">Money reversed</p>
                        </div>
                      </div>
                      <h6 class="mb-0 fw-normal">+$2,235</h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-7">
                      <div class="d-flex">
                        <div class="round-40 bg-primary-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-money.svg" alt="modernize-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                          <h6 class="mb-0 fs-4">Bank Transfer</h6>
                          <p class="fs-3 mb-0">Money added</p>
                        </div>
                      </div>
                      <h6 class="mb-0 text-muted fw-normal">+$320</h6>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-4 pb-4 border-bottom">
                      <div class="d-flex">
                        <div class="round-40 bg-danger-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-pie.svg" alt="modernize-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                          <h6 class="mb-0 fs-4">Refund</h6>
                          <p class="fs-3 mb-0">Bill payment</p>
                        </div>
                      </div>
                      <h6 class="mb-0 text-muted fw-normal">-$32</h6>
                    </div>
                  </div>
  ...
  <script src="./recursos/js/dashboards/dashboard2.js"></script>
</body>
