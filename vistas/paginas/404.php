...
<head>
  ...
  <title>
    404 - Página no encontrada | SITCAV
  </title>
</head>
        ...
        <div class="row justify-content-center w-100">
          <div class="col-lg-4">
            <div class="text-center">
              <img src="./recursos/imagenes/backgrounds/errorimg.svg" alt="MaterialM-img" class="img-fluid" width="500">
              <h1 class="fw-semibold mb-7 fs-9">
                ¡¡¡Opps!!!
              </h1>
              <h4 class="fw-semibold mb-7">
                Esta página que buscas no se pudo encontrar.
              </h4>
