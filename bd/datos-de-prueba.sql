...
insert into productos (id_encargado, url_imagen, id_marca, id, codigo, nombre, descripcion, precio_unitario_actual_dolares, precio_unitario_actual_bcv, cantidad_disponible, dias_garantia, dias_apartado, id_categoria, id_proveedor) values
  (1, 'https://braincorp.net.ve/wp-content/uploads/2025/04/cisco-C1000-16P-2G-L.jpg', 0, 1, 'RTR-001', 'Router Cisco 1000', 'Router de 4 puertos', 100, 100, 0, 30, 7, 1, 1),
  (1, 'https://http2.mlstatic.com/D_NQ_NP_951370-MLV74968554830_032024-O.webp', 0, 2, 'RTR-002', 'Router Cisco 2000', 'Router de 8 puertos', 200, 200, 10, 30, 30, 1, 1),
  (1, 'https://m.media-amazon.com/images/I/21+TTkQQatS._UF894,1000_QL80_.jpg', 0, 3, 'RTR-003', 'Router Cisco 3000', 'Router de 16 puertos', 300, 300, 10, 30, 30, 1, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3uFBEw59Q8T4WSdS1Ed_bGbgF7c_2e13Ksw&s', 0, 4, 'RTR-004', 'Router Cisco 4000', 'Router de 32 puertos', 400, 400, 10, 30, 30, 1, 1),
  (1, 'https://m.media-amazon.com/images/I/61OHroJ1w2L.jpg', 0, 5, 'RTR-005', 'Router Cisco 5000', 'Router de 64 puertos', 500, 500, 10, 30, 30, 1, 1),
  (1, 'https://m.media-amazon.com/images/I/615+56ycedL.jpg', 0, 6, 'MDM-001', 'Modem Cisco 1000', 'Modem de 4 puertos', 100, 100, 10, 30, 30, 2, 1),
  (1, 'https://http2.mlstatic.com/D_NQ_NP_2X_722551-MLV78174011073_082024-N.webp', 0, 7, 'MDM-002', 'Modem Cisco 2000', 'Modem de 8 puertos', 200, 200, 10, 30, 30, 2, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS92kuMV0C_G77Px9VUXFzc_bK5_G5yU7y__Q&s', 0, 8, 'MDM-003', 'Modem Cisco 3000', 'Modem de 16 puertos', 300, 300, 10, 30, 30, 2, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3uFBEw59Q8T4WSdS1Ed_bGbgF7c_2e13Ksw&s', 0, 9, 'MDM-004', 'Modem Cisco 4000', 'Modem de 32 puertos', 400, 400, 10, 30, 30, 2, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBJKqGoe_Bhc5-Di3rNClz6VemLkLoQnNQzg&s', 0, 10, 'MDM-005', 'Modem Cisco 5000', 'Modem de 64 puertos', 500, 500, 10, 30, 30, 2, 1),
  (1, 'https://m.media-amazon.com/images/I/6137g0DeOiL._UF894,1000_QL80_.jpg', 0, 11, 'SWT-001', 'Switch Cisco 1000', 'Switch de 4 puertos', 100, 100, 10, 30, 30, 3, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTShEbhlN1Y1IqfThe_G_coce2dOwHgoJVe8Q&s', 0, 12, 'SWT-002', 'Switch Cisco 2000', 'Switch de 8 puertos', 200, 200, 10, 30, 30, 3, 1),
  (1, 'https://m.media-amazon.com/images/I/811yoXgPirL._UF1000,1000_QL80_.jpg', 0, 13, 'SWT-003', 'Switch Cisco 3000', 'Switch de 16 puertos', 300, 300, 10, 30, 30, 3, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR88SJwPMiuhfIJwFjB5ARxfeBGyLq16CPg5A&s', 0, 14, 'SWT-004', 'Switch Cisco 4000', 'Switch de 32 puertos', 400, 400, 10, 30, 30, 3, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfoGAeXMxdh5uHOK-Rw2V9T2Sx86-lDLtXUg&s', 0, 15, 'SWT-005', 'Switch Cisco 5000', 'Switch de 64 puertos', 500, 500, 10, 30, 30, 3, 1),
  (1, 'https://m.media-amazon.com/images/I/615+56ycedL._UF894,1000_QL80_.jpg', 0, 16, 'ACC-001', 'Accesorio Cisco 1000', 'Accesorio de 4 puertos', 100, 100, 10, 30, 30, 5, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTc4J1Yuyrx9iBUFdHbIJz-L6qeht3Uaiz0yw&s', 0, 17, 'ACC-002', 'Accesorio Cisco 2000', 'Accesorio de 8 puertos', 200, 200, 10, 30, 30, 5, 1),
  (1, 'https://m.media-amazon.com/images/I/811yoXgPirL._UF1000,1000_QL80_.jpg', 0, 18, 'ACC-003', 'Accesorio Cisco 3000', 'Accesorio de 16 puertos', 300, 300, 10, 30, 30, 5, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3uFBEw59Q8T4WSdS1Ed_bGbgF7c_2e13Ksw&s', 0, 19, 'ACC-004', 'Accesorio Cisco 4000', 'Accesorio de 32 puertos', 400, 400, 10, 30, 30, 5, 1),
  (1, 'https://m.media-amazon.com/images/I/71UCKpIKlkL.jpg', 0, 20, 'ACC-005', 'Accesorio Cisco 5000', 'Accesorio de 64 puertos', 500, 500, 10, 30, 30, 5, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrnpOtOeU55qDF15hNQbVy9gD6ueBip3PQCw&s', 0, 21, 'CBL-001', 'Cable Cisco 1000', 'Cable de 4 puertos', 100, 100, 10, 30, 30, 6, 1),
  (1, 'https://http2.mlstatic.com/D_NQ_NP_852781-MLV75612306981_042024-O.webp', 0, 22, 'CBL-002', 'Cable Cisco 2000', 'Cable de 8 puertos', 200, 200, 10, 30, 30, 6, 1),
  (1, 'https://img.genuinemodules.com/cache/catalog/products/QSFP-H40G-CU3M/QSFP-H40G-CU3M-1-800x800.jpg', 0, 23, 'CBL-003', 'Cable Cisco 3000', 'Cable de 16 puertos', 300, 300, 10, 30, 30, 6, 1),
  (1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrnpOtOeU55qDF15hNQbVy9gD6ueBip3PQCw&s', 0, 24, 'CBL-004', 'Cable Cisco 4000', 'Cable de 32 puertos', 400, 400, 10, 30, 30, 6, 1),
  (1, 'https://img.genuinemodules.com/cache/catalog/products/QSFP-4SFP25G-CU5M/QSFP-4SFP25G-CU5M-1-800x800.jpg', 0, 25, 'CBL-005', 'Cable Cisco 5000', 'Cable de 64 puertos', 500, 500, 10, 30, 30, 6, 1),
  (1, 'https://elpuntodelaimpresora.com/wp-content/uploads/2020/10/hp240g7.jpg', 11, 26, null, 'HP 240 G7 Notebook PC', null, 280, 280, 0, 30, 30, 7, 6);
